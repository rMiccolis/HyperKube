...
There are 4 main scripts that create and configure all the infrastructure and need a configuration yaml file (`main_config.yaml`) to be executed (an example is found at [main_config.example](https://github.com/rMiccolis/HyperKube/blob/master/doc/main_config.example.yaml)).
