...
usage(){
  ...
  echo ""
  echo "Usage:"
  echo "  $0 -c '/path/to/the/main_config.yaml' => see the apps_config_example.yaml in the root directory for an example"
  echo ""
  echo "Options:"
...
export custom_mongodb_setup=$(yq ".custom_mongodb_setup // \"false\"" "$variables_file")
